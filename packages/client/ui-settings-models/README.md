...
The `mantur` client build profile keeps the complete Models page but registers neither official onboarding entry. Its product layer owns first-run presentation, while provider configuration remains available from Settings.
